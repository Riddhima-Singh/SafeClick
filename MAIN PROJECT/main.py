...
os.environ["GOOGLE_API_KEY"] = "AIzaSyCxxwqvo0SU8mFErbChGQiPGGxIe-VMZrg"
...
@app.route('/file-history.html')
def file_history():
    return render_template('file-history.html')

# Similarly, for url-history
@app.route('/url-history.html')
def url_history():
    return render_template('url-history.html')
